# Convert Static HTML to Blade Templates Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Convert the public static HTML marketing site into modular Laravel Blade templates.

**Architecture:** Create a unified `layouts/site.blade.php` layout containing the shared HTML wrapper, navbar, and footer. Implement pages extending this layout. Update `routes/web.php` and remove static files.

**Tech Stack:** Laravel, Blade, Tailwind CSS.

---

### Task 1: Create Shared Site Layout (`layouts/site.blade.php`)

**Files:**
- Create: `resources/views/layouts/site.blade.php`

- [ ] **Step 1: Write layouts/site.blade.php**
  Create the master template. In the navbar, check the current active route name to dynamically apply the highlight class `text-amra-primary font-bold` or `text-gray-600 hover:text-amra-primary` to links.
...
### Task 2: Port Pages content to site/ views folder

**Files:**
- Create: `resources/views/site/home.blade.php`, `resources/views/site/about.blade.php`, `resources/views/site/property.blade.php`, `resources/views/site/contact.blade.php`, `resources/views/site/privacy.blade.php`, `resources/views/site/terms.blade.php`

- [ ] **Step 1: Create resources/views/site/home.blade.php**
  Copy the contents of `index.html` main body, replace relative asset links with asset helpers. Add `@extends('layouts.site')`.

- [ ] **Step 2: Create resources/views/site/about.blade.php**
  Copy `pages/about.html` main body content and wrap.

- [ ] **Step 3: Create resources/views/site/property.blade.php**
  Copy `pages/property.html` main body content. Ensure script section goes into `@section('scripts')`.

- [ ] **Step 4: Create resources/views/site/contact.blade.php**
  Copy `pages/contact.html` main body content and wrap.

- [ ] **Step 5: Create resources/views/site/privacy.blade.php** and **terms.blade.php**
  Copy privacy and terms files and wrap.

---

### Task 3: Update Routing & Perform Cleanup

**Files:**
- Modify: `routes/web.php`
- Delete: `index.html`, `pages/`, `public/pages/`

- [ ] **Step 1: Modify routes/web.php**
  Replace file responses with view helper calls:
  ```php
  Route::get('/', function () {
  ...
  ```
  Remove the dynamic `/pages/{page}.html` fallback route since all links now resolve to Laravel view routes.

- [ ] **Step 2: Delete static HTML files**
  Delete:
  - `index.html`
  - `pages/` (entire directory)
  - `public/pages/` (entire directory)
