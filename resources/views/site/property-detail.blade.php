...
<div class="pt-32 pb-24 bg-slate-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <!-- Gallery Slider -->
        <div class="relative bg-black rounded-3xl overflow-hidden shadow-md mb-10 group h-[50vh] md:h-[65vh] min-h-[350px] md:min-h-[500px] max-h-[600px] md:max-h-[750px]">
            @php
            ...
            <div class="lg:col-span-8 flex flex-col gap-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    @if($property->configuration)
                        <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 col-span-2 md:col-span-1">
                            <div class="w-10 h-10 rounded-xl bg-teal-50 text-teal-600 flex items-center justify-center shrink-0">
                                <i data-lucide="home" class="w-5 h-5"></i>
                            </div>
                            <div>
                                <p class="text-[10px] text-slate-400 uppercase tracking-wider font-bold">Configuration</p>
                                <h4 class="text-sm font-extrabold text-slate-700">{{ html_entity_decode(ucwords(strtolower($property->configuration))) }}</h4>
                            </div>
                        </div>
                    @endif
                </div>
                        ...
                        <form id="contact-form" class="flex flex-col gap-4">
                            <div>
                                ...
                                <input type="text" id="first-name" name="first_name" required
                                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all font-medium text-xs text-slate-800" placeholder="John">
                            </div>
                            <div>
                                ...
                                <input type="text" id="last-name" name="last_name" required
                                    class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all font-medium text-xs text-slate-800" placeholder="Doe">
                            </div>
                            <div>
